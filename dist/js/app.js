...
function playSelectionSong() {
  ...
  characterSelectAudio.autoplay = true; // characterSelectAudio.play();
...
function displayCharacter(clickedParent) {
  var characterName = clickedParent.getAttribute('data-character');
...
function sortAndPlaySound(characterName, clickedParent) {
  ...
  if (!isRepeatedSound) {
    ...
    document.querySelector('#img').innerHTML = "<img src=\"img/gifs/".concat(characterName, "/").concat(randNum, ".gif\">");
    var elementUrl = "audio/".concat(characterName, "/").concat(randNum, ".wav");
    var characterVoice = document.querySelector('#characterVoice');
