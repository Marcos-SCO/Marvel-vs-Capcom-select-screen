...
var date = new Date();
var currYearElement = document.querySelector('#currYear');
...
function randomNumber(multiplyBy) {
  var init = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
...
function characterElement(e) {
  e.preventDefault();
  e.stopPropagation();
  var clickedParent = e.target.parentElement;
  var isCharacterElement = clickedParent.hasAttribute('data-character');
...
/******/ 	__webpack_require__.O(undefined, ["dist/css/app"], function() { return __webpack_require__("./src/js/app.js"); })
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["dist/css/app"], function() { return __webpack_require__("./src/css/app.scss"); })
